...
def obtener_fechas_pasaportes():
    try:
        ...
        # Buscar la fila correspondiente al servicio de pasaportes con el texto exacto "renovación y primera vez"
        fila_pasaportes = None
        for fila in tabla.find_all("tr"):
            columnas = fila.find_all("td")
            # Asegurarnos de que estamos buscando la fila exacta
